...
public class RippleViewHelper extends View {
	...
	public RippleViewHelper(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public RippleViewHelper(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public RippleViewHelper(Context context, View targetView) {
	...
	public void init() {
		...
		setLayoutParams(targetParams);
		addToContainer();
	}

	private void resetMargin(View view,ViewGroup.MarginLayoutParams oldParams)
	{
		ViewGroup.MarginLayoutParams newTargetViewParams = new ViewGroup.MarginLayoutParams(oldParams);
		...
		view.setLayoutParams(newTargetViewParams);
	}
	
	private void addToContainer() {

		ViewGroup.MarginLayoutParams targetViewParams = (ViewGroup.MarginLayoutParams) mTargetView
				.getLayoutParams();
		
		ViewParent mParent = mTargetView.getParent();
		mContainer = new FrameLayout(mContext);
		
		if (mParent instanceof ViewGroup) {
			ViewGroup newParent = (ViewGroup) mParent;
			int index = newParent.indexOfChild(mTargetView);
			newParent.removeView(mTargetView);
			newParent.addView(mContainer, index, targetViewParams);
			resetMargin(mTargetView, targetViewParams);
